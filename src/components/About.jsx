    ...
    <Box sx={{
      ...
      <Box sx={{ flex: 2, order: { xs: 2, md: 1 }, marginBottom: { xs: '1rem', md: 0 } }}>
        ...
        <Typography sx={{ color: "#0f112e", lineHeight: "2rem" }} fontStyle={'oblique'} mb={2}>
          Dynamic Software Engineer with 4 years of experience with a proven track record at Deloitte USI, specializing in developing innovative solutions using Node JS and React JS. Excelled in creating responsive designs and enhancing systems performance, significantly reducing processing times. Skilled in JavaScript and adept at mentoring junior developers, showcasing both technical prowess and leadership abilities.
        </Typography>
      </Box>
